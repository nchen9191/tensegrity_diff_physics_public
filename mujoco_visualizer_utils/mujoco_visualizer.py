...
class MuJoCoVisualizer:
    ...
    def __init__(self, render_fps: int = 60, render_size: (int, int) = (720, 720)):
        self.mjc_model = None
        self.mjc_data = None
        self.renderer = None
        self.data = {}
...
if __name__ == '__main__':
    xml_path = Path("../mujoco_physics_engine/xml_models/test.xml")
    data_path = Path('../mujoco_physics_engine/tmp1/data_clockwise012_17.json')
    vid_save_path = Path('../mujoco_physics_engine/tmp1/video_clockwise.mp4')

    visualizer = MuJoCoVisualizer(60, (480, 640))
    visualizer.visualize_from_ext_data(xml_path, data_path, 0.01, vid_save_path)
